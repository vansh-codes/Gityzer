    ...
    <>
      ...
      <div className="flex flex-col justify-between min-h-screen">
        ...
        <header className="p-4 flex flex-row items-center">
          ...
          <a href="/"><h1 className="text-xl font-bold text-white">Gityzer</h1></a>
        </header>
        ...
        <footer className="p-4 text-center text-gray-600">
          Open source ❤️ | <button
            onClick={() => setShowContributors(!showContributors)}
            className="  focus:outline-none"
          >
            {!showContributors? <p>Contributors</p>:<p>Home</p>}
          </button> | <a href="https://github.com/vansh-codes/Gityzer" target="_blank" rel="noreferrer noopener">Gityzer </a>
        </footer>
      </div>
    </>
  );
