...
export default function Badge({ params }) {
  ...
  const updateURL = () => {
    ...
    router.replace(`/${username}/badge?${params.toString()}`, undefined, { shallow: true, scroll: false });
  };
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative flex flex-col gap-2">
      ...
      <div className="flex items-center justify-center mb-2 h-[400px]">
